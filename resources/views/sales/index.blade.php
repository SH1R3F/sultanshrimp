                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 my-4">
                            <h2 class="h4 mb-1">المبيعات | Sales</h2>
                            <p class="mb-3">مبيعات اليوم</p>
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="toolbar">
                                        <div class="form-row">
                                            <div class="form-group col-auto mr-auto">
                                                <a href="{{ route('sales.export', request()->query()) }}" class="btn btn-primary">تصدير الكل | Export all</a>
                                                <form style="display: inline-block" action="{{ route('sales.delete', request()->query()) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <tbody>
                                            @foreach ($sales as $key => $sale)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form style="display: inline-block" action="{{ route('sale.delete', $sale->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
