...
<head>
    ...
    <title>تسجيل مبيعات اليوم</title>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="name">كاش <br /> Cash</div>
                        <div class="value">
                            <div class="input-group-desc">
                                <input class="input--style-5" type="number" name="cash" placeholder="الكاش \ Cash"
                                    required v-model="cash">
                            </div>
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="name">شبكة <br /> Visa</div>
                        <div class="value">
                            <div class="input-group-desc">
                                <input class="input--style-5" type="number" name="cash" placeholder="الشبكة \ Visa"
                                    required v-model="network">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="name">توصيل <br /> Delivery</div>
                        <div class="value">
                            <div class="input-group-desc">
                                <input class="input--style-5" type="number" name="delivery" placeholder="التوصيل \ Delivery"
                                    required v-model="delivery">
                            </div>
                        </div>
                    </div>
        ...
        createApp({
            setup() {
                ...
                const disabled = computed(() => {
                    return loading.value || !name.value || !branch.value || !cash.value || !network.value || !delivery.value
                })
